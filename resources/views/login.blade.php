...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('admin-lte/plugins/froiden-helper/helper.css')}}">
    ...
    <div class="login-box-body">
        ...
        {!!  Form::open(['url' => '', 'method' => 'post','class'=>'login-form']) 	 !!}
            ...
            <div class="row">
                ...
                <!-- /.col -->
                <div class="col-xs-4">
                    <button type="submit" class="btn btn-primary btn-block btn-flat" onclick="login();return false;" > Sign In</button>
                </div>
                <!-- /.col -->
            </div>
        {!! Form::close()  !!}
